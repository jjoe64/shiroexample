-- MySQL dump 10.14  Distrib 5.5.35-MariaDB, for Linux (i686)
--
-- Host: localhost    Database: shiroexample
-- ------------------------------------------------------
...
--
-- Table structure for table `RolesPermission`
--
...
--
-- Dumping data for table `RolesPermission`
--

LOCK TABLES `RolesPermission` WRITE;
...
-- Dump completed on 2014-03-04  8:00:35
